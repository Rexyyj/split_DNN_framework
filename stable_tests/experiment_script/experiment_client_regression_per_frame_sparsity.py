...
import torch
import os
from split_framework.stable.split_framework_regression_sparsity import SplitFramework
import tqdm
import numpy as np
...
def write_time_data(sf, thresh,sparsity,quality,frame_id):
...
def write_characteristic(sf, thresh,sparsity,quality,frame_id):
    real_sparsity, decomposability,regularity,pictoriality = sf.get_tensor_characteristics()
...
if __name__ == "__main__":
    ...
    for j in range(9):
        for i in range(5):
            ...
            # thresh = 0.0
            # quality =100
            print("Testing sparsity: ",sparsity,", Quality: ",quality)
            ...
            for _, imgs, targets in tqdm.tqdm(dataloader, desc="testing"):
                ...
                try:
                    ...
                    print(e)
                    write_map(thresh,sparsity,quality,frame_index,0,0)
