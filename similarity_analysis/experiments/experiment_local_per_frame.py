...
tensor_path = measurement_path+"tensor/"
...
if __name__ == "__main__":
    # Load Model
    model = models_split_tiny.load_model("../ckpt/yolov3_cfg.cfg","../ckpt/yolov3_ckpt_300.pth")
        ...
        for i in range(1):
            ...
            for _, imgs, targets in tqdm.tqdm(dataloader, desc="testing"):
                ...
                with torch.no_grad():
                    ...
                    torch.save(head_tensor,tensor_path+str(frame_index)+".pt")
